#!/usr/bin/env python3
"""
Run the linear GAE time-split baseline across multiple seeds.
"""
import argparse
import json
...
def main():
    ...
    ap.add_argument('--out-report', default='artifacts/linear_gae_time_multiseed.json')
    ap.add_argument('--out-csv', default='artifacts/linear_gae_time_multiseed.csv')
    ...
    if args.log:
        row = {
            ...
            'model': 'linear_gae_time_multiseed',
            'edges': args.edges,
            'test_ratio': args.test_ratio,
